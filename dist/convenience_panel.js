...
export function fully_build({ services }) {
    ...
    const { launch_all_messages, launch_mentions, launch_recent_conversations, launch_starred_messages, all_messages_menu, starred_messages_menu, translate, } = services;
